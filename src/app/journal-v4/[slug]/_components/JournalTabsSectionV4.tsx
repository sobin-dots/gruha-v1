...
import { JournalProfileV4 } from "./tab-contents/JournalProfileV4";
import JournalJourneyV4 from "./tab-contents/JournalJourneyV4";
import JournalSearchV4 from "./tab-contents/JournalSearchV4";
import JournalProjectsV3 from "@/app/journal-v3/[slug]/_components/tab-contents/JournalProjectsV3";
import JournalLearningsV3 from "@/app/journal-v3/[slug]/_components/tab-contents/JournalLearningsV3";
import JournalStartHereV3 from "@/app/journal-v3/[slug]/_components/tab-contents/JournalStartHereV3";
...
interface JournalTabsSectionV4Props {
  tabs?: TabItem[];
}

export const JournalTabsSectionV4: React.FC<JournalTabsSectionV4Props> = ({
  tabs: passedTabs = [],
}) => {
  ...
  const renderTabContent = (tab: any) => {
    switch (tab.id) {
      case "profile": {
        ...
        return <JournalProfileV4 {...profileData} />;
      }
      ...
      case "journey": {
        ...
        return <JournalJourneyV4 {...journeyData} />;
      }
      ...
      case "search": {
        ...
        return <JournalSearchV4 {...searchData} />;
      }
  ...
  const handleScroll = () => {
    ...
    for (let i = sectionIds.length - 1; i >= 0; i--) {
      ...
      const el = document.getElementById(`v4-section-${id}`);
      if (el) {
  ...
  return (
    <div className="w-full relative">
      ...
      <div className="sticky top-0 z-50 bg-white pt-8 pb-0 border-b border-[#E4E9EF]">
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`relative group shrink-0 transition-colors cursor-pointer border-none bg-transparent ${isActive ? "z-20 text-[#111821]" : "z-10 text-[#59636F] hover:text-[#111821]"
                    }`}
                >
                  {/* Folder Tab Vector */}
                  <svg
                  ...
                  <div className="absolute inset-0 pt-3 px-4 flex items-center justify-center gap-2">
                    ...
                    {tab.badgeCount && (
                      <span
                        className={`text-[10.5px] font-semibold px-2 py-0.5 rounded-full font-sans ${isActive
      ...
      <section className="bg-[#F3F6F9] ">
        ...
        <div className="max-w-[1120px] mx-auto px-4 sm:px-8  pt-12 pb-20 space-y-24">
          {tabs.map((tab: any) => (
            <div
              key={tab.id}
              id={`v4-section-${tab.id}`}
...
export default JournalTabsSectionV4;

...
import { JournalBreadCrumbsV2 } from "./_components/JournalBreadCrumbsV2";
import { RiyaDockedWidget } from "./_components/RiyaDockedWidget";
...
export default async function JournalSlugPage({
    ...
    return (
        <>
            ...
            >
                {/* ── Top Bar Header ────────────────────────────────────────── */}
                <JournalBreadCrumbsV2 title={article.title} />
                ...
                {/* ── Section 2 — Section Index & Tabs Content ─────────────── */}

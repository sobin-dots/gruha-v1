...
export interface JournalLearningsV3Props {
  eyebrow?: string;
  title: string;
  description: string;
  lessonsTitle?: string;
...
export const JournalLearningsV3: React.FC<JournalLearningsV3Props> = ({
  ...
  return (
    <section id="v3-section-learnings" className="w-full space-y-12" aria-label="Key learnings">
      {/* Section Head */}
...
export default JournalLearningsV3;
